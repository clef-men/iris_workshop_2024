...
\begin{mathpar}
    \inferrule*[lab=RelDir (\Simuliris)]
        ...
        \\\\
            \mathcolor{magenta}{\datalangVal_s} \iSimilar \mathcolor{magenta}{\datalangVal_t}
        \\\\
            \forall \mathcolor{teal}{\datalangValTwo_s}, \mathcolor{teal}{\datalangValTwo_t} \ldotp
            \mathcolor{teal}{\datalangValTwo_s} \iSimilar \mathcolor{teal}{\datalangValTwo_t} \iWand
            \iPred (\mathcolor{teal}{\datalangValTwo_s}, \mathcolor{teal}{\datalangValTwo_t})
        }{
            \iSim{
                \iPred
            }{
...
\[
    \iSimvHoarePretty{
        ...
        \datalangUnit, \mathcolor{teal}{\datalangValTwo_t} \ldotp
            \exists \mathcolor{teal}{\datalangValTwo_t} \ldotp
            \mathcolor{teal}{\datalangValTwo_s} \iSimilar \mathcolor{teal}{\datalangValTwo_t} \iSep
            (\mathcolor{blue}{\datalangLoc} + \datalangIdx) \iPointsto_t \mathcolor{teal}{\datalangValTwo_t}
    }
\]
\vfill
\begin{mathpar}
    \inferrule*[lab=RelDPS]
        ...
        \\\\
            \forall \mathcolor{teal}{\datalangValTwo_s}, \mathcolor{teal}{\datalangValTwo_t} \ldotp
            \mathcolor{teal}{\datalangValTwo_s} \iSimilar \mathcolor{teal}{\datalangValTwo_t} \iWand
            \mathcolor{blue}{\datalangLoc} \iPointsto_t \overline{\datalangVal} [\datalangIdx \mapsto \mathcolor{teal}{\datalangValTwo_t}] \iWand
            \iPred (\mathcolor{teal}{\datalangValTwo_s}, \datalangUnit)
        }{
            \iSim{
                \iPred
            }{
    ...
    \inferrule*[lab=RelProtocol]
        {
            \mathcolor{red}{\iProt} (\datalangExpr_s, \datalangExpr_t, \mathcolor{cyan}{\iPredTwo})
        \and
            \forall \datalangExpr_s', \datalangExpr_t' \ldotp
            \mathcolor{cyan}{\iPredTwo} (\datalangExpr_s', \datalangExpr_t') \iWand
            \iSim[
                \mathcolor{red}{\iProt}
            ]{
                \iPred
