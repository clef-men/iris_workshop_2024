...
\begin{tikzpicture}[yscale=-1]
    ...
    \draw [fill=teal, fill opacity=0.4] (0,1.5) rectangle (1,2.5) node [pos=.5] {\texttt{f x}} ;
    \draw [fill=magenta, fill opacity=0.4, dashed] (2,1.5) rectangle (5,2.5) node [pos=.5] {\texttt{xs}} ;
    
    \draw [fill=teal, fill opacity=0.4] (0,3) rectangle (1,4) node [pos=.5] {\texttt{f x}} ;
    \draw [fill=teal, fill opacity=0.4, dashed] (2,3) rectangle (5,4) node [pos=.5] {\texttt{map f xs}} ;
    
    \draw [fill=teal, fill opacity=0.4] (0,4.5) rectangle (1,5.5) node [pos=.5] {\texttt{f x}} ;
    \draw [fill=teal, fill opacity=0.4, dashed] (2,4.5) rectangle (5,5.5) node [pos=.5] {\texttt{map f xs}} ;
    \draw [thick, ->] (1,5) -- (2,5) ;
\end{tikzpicture}
\end{frame}
...
\centering
\begin{tikzpicture}[yscale=-1]
    \draw [fill=teal, fill opacity=0.4, dashed] (0,0) rectangle (3,1) node [pos=.5] {\texttt{acc}} ;
    ...
    \draw [fill=teal, fill opacity=0.4, dashed] (0,1.5) rectangle (3,2.5) node [pos=.5] {\texttt{acc}} ;
    \draw [fill=teal, fill opacity=0.4] (4,1.5) rectangle (5,2.5) node [pos=.5] {\texttt{f x}} ;
    \draw [fill=magenta, fill opacity=0.4, dashed] (6,1.5) rectangle (9,2.5) node [pos=.5] {\texttt{xs}} ;
    
    \draw [fill=teal, fill opacity=0.4, dashed] (0,3) rectangle (3,4) node [pos=.5] {\texttt{acc}} ;
    \draw [fill=teal, fill opacity=0.4] (4,3) rectangle (5,4) node [pos=.5] {\texttt{f x}} ;
